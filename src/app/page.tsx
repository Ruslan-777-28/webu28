      ...
      <div className="relative w-full md:flex-grow md:min-w-0 bg-white flex flex-col" style={{ flexBasis: '85%' }}>
        ...
        <div className="flex-grow flex flex-col items-center justify-center pt-8">
            ...
            <div className="text-center text-sm text-muted-foreground max-w-[500px] mt-8">
                <p className="mb-4">
ВІДКРИЙ ДОСТУП ДО ЗНАНЬ БЕЗ КОРДОНІВ  24/7  Відповіді на важливі питання про стосунки, життєві рішення та власний шлях.  Такі розмови допомагають подивитися на ситуацію з іншого боку, отримати нове бачення та знайти власні рішення, краще зрозуміти події, цикли та внутрішні процеси людини.   Ідея платформи проста: коли час, компетенція, досвід  та знання об’єднуються у змістовній розмові, виникає справжня цінність для обох сторін. Спілкуйся з кращими  експертами, практиками й провідниками з усього світу у форматі, який зручний саме тобі.  4 типи комунікації з консультацій духовних практик з усіх куточків світу , без мовного бар'єру .Екосистема обміну живою енергією . Отримуй персональні відповіді, глибші інсайти та живу взаємодію без мовних і географічних бар’єрів.
                </p>
            </div>
        </div>
